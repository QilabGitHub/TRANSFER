...
% analyzed. For Endosome channel, a threshold value will be calculated based on 
% the pixel intensity statistics within the cell ROI. A binary mask will 
% then be created by applying thresholding in the Endosome images. For GFP,
% a threshold value will be calculated based on the pixel intensity
...
OMM_thres_factor = 2;           % * STD; thresholding factor for Endosome channel
RNA_Cas_thres_factor = 2;        % * STD .DEFAULT IS 1; thresholding factor for GFP channel

% Define the filename for the output data
table_name = 'co-localization_Mengting_code_OMM2-RNA2.csv';
...
channel_seq = readtable ('Channel_sequence_GFP.xlsx');
